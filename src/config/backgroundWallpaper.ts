...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	 ...
	 * desktop: "assets/images/DesktopWallpaper/example1.avif", // 单张图片
	 *
	 * mobile: "https://t.alcy.cc/mp", // 随机图API
	 * mobile: "assets/images/MobileWallpaper/example1.avif", // 单张图片
	 *
	 * 支持配置多张图片（数组），每次刷新页面随机显示一张：
	 * desktop: [
	 * "assets/images/DesktopWallpaper/example1.avif",
	 * "assets/images/DesktopWallpaper/example2.avif",
	 * ],
	 *
	 * mobile:[
	 *   "assets/images/MobileWallpaper/example1.avif",
	 *   "assets/images/MobileWallpaper/example2.avif",
	 * ],
	 */
	src: {
		// 桌面背景图片（支持单张或多张随机）
		// desktop: "assets/images/DesktopWallpaper/example1.avif",
		desktop: [
			// "assets/images/DesktopWallpaper/example1.avif",
			"https://t.alcy.cc/pc",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/example1.avif",
		mobile: [
			// "assets/images/MobileWallpaper/example1.avif",
			"https://t.alcy.cc/mp",
		],
