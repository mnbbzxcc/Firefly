...
export const site = {
  name: "未完成",
  desc: "正在加载中",
  url: "https://www.303009.xyz",
  avatar: "https://weavatar.com/avatar/efdaff3b8ba86cd2b30bfc4d43daa457613e450b910ba13a5141bea96908665c.png?s=1080",
  email: "kuang-san@foxmail.com",
};

{/* ========= 我希望 ========== */}

export const notes = [
  { title: "互换原则", content: "希望您先添加本站" },
  { title: "链接维护", content: "希望可以长期维护" },
  { title: "内容有趣", content: "希望您的内容有趣" },
];
